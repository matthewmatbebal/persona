                ...
                <div className={styles.heroInner}>
                    <div className={styles.heroContent}>
                        ...
                        <p className={styles.heroSubtitle}>
                            ...
                            Законом <br/> №152-ФЗ "О персональных данных"
                        </p>
                    </div>
                    <Image
                        src="./lock.svg"
            ...
            <div className={styles.servicesInner}>
                ...
                <div className={styles.servicesGrid}>
                    ...
                    <div className={styles.card03Container}>
                        ...
                        <ServiceCard
                          number="06"
                          title="Обучение/консультация Ваших сотрудников по работе с ПДн"
                          description="Проведем вебинар: по работе с клиентами, по защите персональных данных работников. Необходимо каждому - от собственника бизнеса до сотрудника кадрового отдела."
                        />
                    </div>
                    <ServiceCard
                        number="04"
            ...
            <div className={styles.stepsContent}>
                <div className={styles.stepsRow}>
                    ...
                    <NumberCard
                        ...
                        description="Разрабатываем документы, консультируем сотрудников, даем инструкции по с работе с ПДн"
                    />
                    <Arrow/>
                    <NumberCard
                        number="05"
